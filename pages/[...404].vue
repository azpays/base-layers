        ...
        <form action="#" method="post">
          <div
            ...
            <div>
              <button
                type="submit"
                class="py-3 px-5 w-full text-sm font-medium text-center bg-blue-700 text-white rounded cursor-pointer hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                Submit
              </button>
            </div>
          </div>
